...
Revision ID: f11983a53c2b
Revises: 6562749f3fc5
Create Date: 2026-01-12 20:11:02.868920
...
revision = 'f11983a53c2b'
down_revision = '6562749f3fc5'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('ai_version', sa.INTEGER(), nullable=True),
    sa.Column('last_prompt_addon', sa.TEXT(), nullable=True),
