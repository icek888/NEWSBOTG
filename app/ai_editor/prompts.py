...
Правила:
1. Заголовок: название инструмента + что делает (до 80 символов)
2. Ключевые фичи: 3-4 буллета, конкретно и практично
3. Установка/пример: 1 команда (pip install, npm install и т.д.)
4. "Зачем попробовать": 1 предложение про пользу
5. Теги: 3-5 релевантных
6. Тон: энтузиаст-разработчик, не маркетолог

Формат ответа (строго JSON):
{
  "headline": "Краткий заголовок",
  "summary_bullets": ["фича1", "фича2", "фича3"],
  "meaning": "Зачем попробовать этот инструмент",
  "tags": ["ai", "github", "tool"],
